...
export const theme = {
  colors: {
    ...
    // Escala sobre navy — para la cabecera oscura de Inicio.
    // Sobre fondo navy no sirve `primary`: es muy oscuro y no contrasta. Se usa `mint`.
    heroTop: '#123661',      // navy claro (arriba del degradado de la cabecera)
    heroBottom: '#0B2140',   // navy profundo (abajo)
    onNavy: '#FFFFFF',
    onNavySoft: '#9DB6D6',   // texto secundario sobre navy
    onNavyFill: 'rgba(255,255,255,0.10)',
    onNavyBorder: 'rgba(255,255,255,0.14)',
    mint: '#4FE0CE',         // turquesa legible sobre navy
    mintInk: '#04302C',      // texto sobre mint
    alerta: '#FFC46B',       // ámbar sobre navy (vencimientos)
  },
  radius: {
    sm: 10,
    md: 14,
